...
# Set Page Config
st.set_page_config(page_title="Support Assistant", layout="wide", page_icon="✨")
...
st.title("✨ Enterprise Support Assistant")
st.markdown("##### *Your dynamic, context-aware AI support agent.*")
st.divider()
...
# ====== MAIN CHAT UI ======
st.subheader("💬 Active Support Session")

# Empty State
if not st.session_state.chat_history:
    st.info("👋 Welcome! Please upload a PDF in the sidebar and click **Process & Index Documents** to start.")
